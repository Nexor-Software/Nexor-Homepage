...
import React, { createContext, useState, useContext, useRef, useEffect, ComponentProps } from 'react';
...
export const CardBody = ({ children, className }: CardBodyProps) => {
	return (
		<div
			className={cn(
				'h-96 w-96 [transform-style:preserve-3d] [&>*]:[transform-style:preserve-3d] rounded-2xl',
				className
			)}>
			{children}
		</div>
...
export const CardItem = ({
	...
	return React.createElement(
		...
		{
			ref,
			className: cn('w-fit transition duration-200 ease-linear rounded-2xl', className),
			...rest,
		},
		children
	);
