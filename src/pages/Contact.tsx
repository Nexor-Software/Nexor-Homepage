            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-lg text-[#B0C4D4] font-inter leading-relaxed">
                  ...
                  need a quote for your project, or just want to say hello, we'd love to hear from you.
                </p>
              </div>
                  ...
                  <Card key={index} className="bg-[#0F2235] border-[#30D6C4]/20">
                    <CardContent className="p-6">
                      <div className="flex items-start space-x-4">
                        ...
                        <div>
                          <h3 className="text-white font-inter font-medium mb-2">
                            {info.title}
                          </h3>
                          {info.link ? (
                            <a 
                            ...
                            <p className="text-[#B0C4D4] font-inter whitespace-pre-line">
                              {info.content}
                            </p>
                          )}
                        </div>
